...
public class ContestantContestViewSubMadeImp implements ContestantContestViewSubMade 
{
	...
	public ContestantContestViewSubMadeImp(){
		myPanel = new JPanel();
		myEntryFile = null;
	...
	@Override
	public void submitNewEntry(User theUser, EntryDatabaseManager theEntryDataBaseManager, Contest theContest) {
